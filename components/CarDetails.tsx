...
interface CarDetailsProps {
    // enables us to add props to CarDetails and make them usable in CarCard component
    isOpen: boolean;
    closeModal: () => void;
    car: CarProps;
}
          ...
          <div className='fixed inset-0 overflow-y-auto'>
            <div className='flex min-h-full items-center justify-center p-4 text-center'>
              ...
              >
                ...
                overflow-y-auto transform rounded-2xl p-6 bg-white text-left shadow-xl 
                ...
                >
                  ...
                  <div className='flex-1 flex flex-col gap-2'>
                    ...
                    <div className='mt-3 flex flex-wrap gap-4'>
                      {/* Map and return the Car props( keys: pair ) to display Car info */}
